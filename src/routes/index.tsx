...
async function App() {
  ...
  return (
    <div className="space-y-12 bg-linear-to-b from-slate-50 via-white to-slate-60 p-6">
      <section>
        <Card className="p-8 shadow-md bg-white/80">
          ...
          <CardDescription>
            <Link
              to="/products"
              className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:-translate-y-0.6 hover:shadow-xl"
            >
              Browse Products
